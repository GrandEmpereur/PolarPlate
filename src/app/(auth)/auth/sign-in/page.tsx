...
import { Github, Loader2, Mail, KeyRound, ArrowRight, ArrowLeft, Home } from "lucide-react";
...
export default function SignIn() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-b from-background to-muted/20 p-4 relative overflow-hidden">
      ...
      <div className="flex flex-col md:flex-row max-w-4xl w-full gap-6 z-10">
        {/* Image et texte d'introduction */}
        <motion.div 
          className="hidden md:flex flex-col justify-center items-center md:w-1/2 p-6 rounded-2xl bg-primary/5 backdrop-blur-sm"
          ...
          <div className="relative w-64 h-64 mb-8">
            <Image 
              ...
              onError={(e) => {
                ...
                target.src = "https://illustrations.popsy.co/amber/login.svg";
              }}
            />
          </div>
          <h2 className="text-2xl font-bold text-center mb-4">Bienvenue sur PolarPlate</h2>
          <p className="text-center text-muted-foreground max-w-sm">
            Connectez-vous pour accéder à votre espace personnel et profiter de toutes les fonctionnalités de la plateforme.
          </p>
        </motion.div>
